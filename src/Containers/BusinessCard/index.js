    ...
    <ScrollView style={{flex: 1}}>
      ...
      <View style={styles.cardWrap}>
        <View style={styles.cardContent}>
          ...
          {/* divider start */}
          <View style={{width: "100%", height: 1, backgroundColor: "#000", alignSelf: "center", marginVertical: 10}} />
          {/* divider end */}
          <Text style={{color: "#184461", textAlign: "center", fontSize: 14, marginBottom: 10}}>Click the button below to add your card</Text>
                ...
                <TouchableOpacity 
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            fontSize: 16,
                            fontWeight: "bold"
                        }}>{businessCards[key].fullname}</Text>
                        <Text style={{
                            color: "#000",
                            fontSize: 15
                        }}>{businessCards[key].businessName}</Text>
                        <TouchableOpacity onPress={()=> {
                            Linking.openURL("https://" + businessCards[key].businessWebsite).catch(err=> console.log(err));
                        }}>
                        <Text style={{
                            color: "blue",
                            fontSize: 15,
                        ...
                        }}>{businessCards[key].businessWebsite}</Text>
                        </TouchableOpacity>
                        <Text style={{
                            color: '#000',
                            fontSize: 15
                        }}>{businessCards[key].phone}</Text>
                        {
                    ...
                    <View style={{
                        ...
                        <Image source={Images.Plaza33Logo} style={{
                            width: 100,
                            height: 100,
                            resizeMode: "contain"
                        }} />
